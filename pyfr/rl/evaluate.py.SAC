...
def evaluate_policy(mesh_file, cfg_file, backend_name, load_model, ic_dir=None, episodes=1):
    ...
    # Actor network with proper output handling - MUST match train.py exactly
    ...
    # Use the same parameter extractor as train.py
    ...
    policy = ProbabilisticActor(
        ...
        return_log_prob=False,  # Match train.py setting
        distribution_kwargs={
