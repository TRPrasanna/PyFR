...
<%pyfr:macro name='bc_rsolve_state' params='ul, nl, ur' externs='ploc, t, control_params, t_act_interval, actuator_bounds'>
% for v in 'uvw'[:ndims]:
    fpdtype_t bc_${v} = 0.0;
% endfor
...
<%pyfr:macro name='bc_ldg_state' params='ul, nl, ur' externs='ploc, t, control_params, t_act_interval, actuator_bounds'>
% for v in 'uvw'[:ndims]:
    fpdtype_t bc_${v} = 0.0;
% endfor
